...
<body class="h-screen flex overflow-hidden" style="background:#0A0F1E">
  ...
  <!-- ── Right panel ─────────────────────────────────────────────────── -->
  <div class="flex-1 bg-[#121620]/60 flex items-center justify-center px-8">
    <div class="w-full max-w-[360px]">
      ...
      <p class="mt-1 text-sm text-gray-400">Gunakan kredensial yang diberikan oleh admin sistem.</p>
      ...
      <div class="mt-5 flex items-start gap-2.5 px-4 py-3 rounded-xl bg-emerald-50 border border-emerald-100">
        <svg class="w-4 h-4 text-emerald-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
        </svg>
        <p class="text-sm text-emerald-700"><?= esc(session()->getFlashdata('success')) ?></p>
      </div>
      <?php endif; ?>
      ...
      <p class="mt-8 text-center text-xs text-gray-400">
        Pelapor Kerusakan? 
        <a href="/register" class="text-[#CCFF00] font-semibold hover:underline">Daftar Akun Baru</a>
      </p>
