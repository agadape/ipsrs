...
<div class="space-y-6 max-w-5xl mx-auto">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    <div class="bg-white rounded-3xl p-6 shadow-[0_4px_24px_rgba(0,0,0,0.02)] border border-gray-100 flex items-center gap-5">
      ...
      <div>
        ...
        <div class="flex items-end gap-2">
          <h3 class="text-3xl font-black text-gray-800 leading-none"><?= esc($totalActive) ?></h3>
          <span class="text-sm font-medium text-gray-500 mb-1">Laporan</span>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-3xl p-6 shadow-[0_4px_24px_rgba(0,0,0,0.02)] border border-gray-100 flex items-center gap-5">
      ...
      <div>
        ...
        <div class="flex items-end gap-2">
          <h3 class="text-3xl font-black text-gray-800 leading-none"><?= esc($totalDone) ?></h3>
          <span class="text-sm font-medium text-gray-500 mb-1">Laporan</span>
        </div>
      </div>
    </div>
