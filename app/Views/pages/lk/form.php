...
<div class="flex items-center gap-3 mb-6">
  ...
  <div>
    <h1 class="text-xl font-bold text-gray-100">Buat Laporan Kerusakan</h1>
...
<form method="POST" action="/ipsrs/lk/baru">
  ...
  <div class="card p-6 mb-5">
    <h2 class="text-sm font-semibold text-gray-200 mb-5 pb-3 border-b border-white/5">Identifikasi Pelapor</h2>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <!-- Jam Laporan -->
      <div>
        <label class="block text-xs font-semibold text-gray-300 mb-1.5">Jam Laporan <span class="text-red-500">*</span></label>
      ...
      <!-- Pelapor -->
      <div>
        <label class="block text-xs font-semibold text-gray-300 mb-1.5">Pelapor <span class="text-red-500">*</span></label>
      ...
      <!-- Unit Pelapor -->
      <div>
        <label class="block text-xs font-semibold text-gray-300 mb-1.5">Unit Pelapor <span class="text-red-500">*</span></label>
  ...
  <div class="card p-6 mb-5">
    <h2 class="text-sm font-semibold text-gray-200 mb-5 pb-3 border-b border-white/5">Detail Kerusakan</h2>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">

      <!-- Keluhan -->
      <div class="md:col-span-2">
        <label class="block text-xs font-semibold text-gray-300 mb-1.5">Keluhan <span class="text-red-500">*</span></label>
        <textarea name="keluhan" rows="3" required
                  placeholder="Deskripsikan keluhan atau kerusakan yang dilaporkan..."
                  class="w-full px-3 py-2.5 text-sm bg-[#181C25]/80 border-0 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-400/50 resize-none"><?= esc(old('keluhan') ?? '') ?></textarea>
      </div>
      ...
      <!-- Aset (optional) -->
      <div>
        <label class="block text-xs font-semibold text-gray-300 mb-1.5">Aset Terkait <span class="text-gray-400 font-normal">(opsional)</span></label>
        <select name="id_aset"
                class="w-full px-3 py-2.5 text-sm bg-[#181C25]/80 border-0 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-400/50 appearance-none">
      ...
      <!-- Nama Aset -->
      <div>
        <label class="block text-xs font-semibold text-gray-300 mb-1.5">Nama Aset <span class="text-gray-400 font-normal">(jika tidak ada di daftar)</span></label>
  ...
  <div class="flex items-center gap-3">
    ...
    <a href="/ipsrs/lk" class="px-5 py-2.5 text-sm text-gray-400 hover:text-gray-700 bg-[#121620]/60 rounded-xl border border-white/10 hover:bg-white/5 transition-colors">
      Batal
    </a>
  </div>
