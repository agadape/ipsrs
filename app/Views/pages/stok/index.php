...
<div class="flex items-center justify-between mb-6">
  <div>
    <h1 class="text-xl font-bold text-gray-800">Stok &amp; Suku Cadang</h1>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
  ...
  <button type="button" onclick="toggleStokForm('form-masuk')"
    ...
    <h2 class="text-sm font-bold text-gray-800">Stok Masuk</h2>
  ...
  <button type="button" onclick="toggleStokForm('form-keluar')"
    ...
    <h2 class="text-sm font-bold text-gray-800">Stok Keluar</h2>
...
<div id="stok-forms-container">
  ...
  <div id="form-masuk" class="stok-form hidden card p-6 md:p-8 mb-6 border-t-4 border-emerald-500 shadow-xl shadow-emerald-500/10">
    <div class="flex items-center justify-between mb-6">
      <h2 class="text-base font-bold text-gray-800">Catat Penerimaan Barang Masuk</h2>
    ...
    <form method="POST" action="/ipsrs/stok/masuk" class="grid grid-cols-1 md:grid-cols-2 gap-5">
      <?= csrf_field() ?>
      <div class="md:col-span-2">
        <label class="block text-xs font-bold text-gray-700 mb-2 uppercase tracking-wide">Pilih Barang <span class="text-red-500">*</span></label>
        <select name="id_barang" required class="w-full px-4 py-3 text-[15px] bg-gray-50 border-0 rounded-2xl focus:outline-none focus:ring-2 focus:ring-emerald-500/50 appearance-none shadow-inner">
      ...
      <div>
        <label class="block text-xs font-bold text-gray-700 mb-2 uppercase tracking-wide">Jumlah <span class="text-red-500">*</span></label>
        <input type="number" name="jumlah" min="1" required placeholder="0" class="w-full px-4 py-3 text-[15px] bg-gray-50 border-0 rounded-2xl focus:outline-none focus:ring-2 focus:ring-emerald-500/50 shadow-inner">
      </div>
      <div>
        <label class="block text-xs font-bold text-gray-700 mb-2 uppercase tracking-wide">Tanggal Masuk</label>
        <input type="date" name="tanggal" value="<?= date('Y-m-d') ?>" class="w-full px-4 py-3 text-[15px] bg-gray-50 border-0 rounded-2xl focus:outline-none focus:ring-2 focus:ring-emerald-500/50 shadow-inner">
      </div>
      <div>
        <label class="block text-xs font-bold text-gray-700 mb-2 uppercase tracking-wide">No. Dokumen / PO</label>
        <input type="text" name="no_dokumen" placeholder="Contoh: INV-2023/001" class="w-full px-4 py-3 text-[15px] bg-gray-50 border-0 rounded-2xl focus:outline-none focus:ring-2 focus:ring-emerald-500/50 shadow-inner">
      </div>
      <div>
        <label class="block text-xs font-bold text-gray-700 mb-2 uppercase tracking-wide">Keterangan Tambahan</label>
        <input type="text" name="keterangan" placeholder="Opsional" class="w-full px-4 py-3 text-[15px] bg-gray-50 border-0 rounded-2xl focus:outline-none focus:ring-2 focus:ring-emerald-500/50 shadow-inner">
      </div>
      <div class="md:col-span-2 pt-2">
  ...
  <div id="form-keluar" class="stok-form hidden card p-6 md:p-8 mb-6 border-t-4 border-red-500 shadow-xl shadow-red-500/10">
    <div class="flex items-center justify-between mb-6">
      <h2 class="text-base font-bold text-gray-800">Catat Pengeluaran Material</h2>
    ...
    <form method="POST" action="/ipsrs/stok/keluar" class="grid grid-cols-1 md:grid-cols-2 gap-5">
      ...
      <div class="md:col-span-2">
        <label class="block text-xs font-bold text-gray-700 mb-2 uppercase tracking-wide">Pilih Barang <span class="text-red-500">*</span></label>
        <select name="id_barang" required class="w-full px-4 py-3 text-[15px] bg-gray-50 border-0 rounded-2xl focus:outline-none focus:ring-2 focus:ring-red-500/50 appearance-none shadow-inner">
      ...
      <div>
        <label class="block text-xs font-bold text-gray-700 mb-2 uppercase tracking-wide">Jumlah Dipakai <span class="text-red-500">*</span></label>
        <input type="number" name="jumlah" min="1" required placeholder="0" class="w-full px-4 py-3 text-[15px] bg-gray-50 border-0 rounded-2xl focus:outline-none focus:ring-2 focus:ring-red-500/50 shadow-inner">
      </div>
      <div>
        <label class="block text-xs font-bold text-gray-700 mb-2 uppercase tracking-wide">Tanggal Keluar</label>
        <input type="date" name="tanggal" value="<?= date('Y-m-d') ?>" class="w-full px-4 py-3 text-[15px] bg-gray-50 border-0 rounded-2xl focus:outline-none focus:ring-2 focus:ring-red-500/50 shadow-inner">
      </div>
      <div>
        <label class="block text-xs font-bold text-gray-700 mb-2 uppercase tracking-wide">Keperluan / Laporan LK</label>
        <input type="text" name="no_dokumen" placeholder="Contoh: LK-230501" class="w-full px-4 py-3 text-[15px] bg-gray-50 border-0 rounded-2xl focus:outline-none focus:ring-2 focus:ring-red-500/50 shadow-inner">
      </div>
      <div>
        <label class="block text-xs font-bold text-gray-700 mb-2 uppercase tracking-wide">Keterangan Teknisi</label>
        <input type="text" name="keterangan" placeholder="Opsional" class="w-full px-4 py-3 text-[15px] bg-gray-50 border-0 rounded-2xl focus:outline-none focus:ring-2 focus:ring-red-500/50 shadow-inner">
      </div>
      <div class="md:col-span-2 pt-2">
    ...
    <table class="w-full text-[14px]">
      ...
      <tbody class="divide-y divide-gray-100">
        ...
        <tr class="hover:bg-indigo-50/40 transition-colors group cursor-pointer">
          ...
          <td class="px-6 py-4"><span class="<?= $stBadge ?> shadow-sm"><?= $stLabel ?></span></td>
        </tr>
        <?php endforeach; ?>
      </tbody>
    </table>
