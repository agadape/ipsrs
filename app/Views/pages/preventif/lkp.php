  ...
  <div id="checklist-area" class="hidden">
    <div class="card p-6 mb-6">
      ...
      <div class="mt-6 pt-5 border-t border-dashed border-gray-200 flex flex-wrap gap-3 hidden" id="add-buttons">
        ...
        <button type="button" onclick="addCustomRow('Service')" class="flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 hover:bg-blue-100 text-blue-700 text-xs font-semibold rounded-lg transition-colors">
    ...
    <div class="card p-6 mb-5">
      ...
      <div class="space-y-5">
        <!-- Lokasi Alat -->
        <div class="mb-5">
          <label class="block text-xs font-semibold text-gray-600 mb-2.5">Lokasi Alat Sesuai? <span class="text-red-500">*</span></label>
          <div class="flex flex-wrap gap-4">
            <label class="flex items-center gap-2 cursor-pointer group">
              ...
              <span class="text-sm font-medium text-gray-700 group-hover:text-gray-900">Ya, Sesuai</span>
            </label>
            <label class="flex items-center gap-2 cursor-pointer group">
              <input type="radio" name="lokasi_sesuai" value="Tidak Sesuai" required
                     class="w-4 h-4 text-indigo-600 focus:ring-indigo-400/50 cursor-pointer">
              <span class="text-sm font-medium text-gray-700 group-hover:text-gray-900">Tidak, Berpindah</span>
            </label>
          </div>
        </div>
