...
INSERT INTO `pengguna` (`id`, `email`, `password_hash`, `nama_lengkap`, `role`, `unit`, `aktif`) VALUES
  ('e1000000-0000-0000-0000-000000000001', 'admin@rsud-jogja.go.id', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Administrator', 'Admin', 'IPSRS', 1);
