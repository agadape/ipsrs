-- =========================================================================
-- MIGRATION SCRIPT v2: MEMBUAT ASET MENJADI PARENT-CHILD (SERIES)
-- =========================================================================
...
INSERT IGNORE INTO `aset_series` 
...
-- 3. Update relasi pada komponen_aset
...
-- 4. Update relasi pada riwayat_lokasi_aset
...
-- 5. Update relasi pada lembar_kerja
...
-- 6. Update relasi pada lembar_kerja_preventif
...
-- 7. Update tabel jadwal_preventif (hanya kolom aset yang diubah isinya)
UPDATE `jadwal_preventif` jp JOIN `aset_series` aser ON jp.aset = aser.id_aset SET jp.aset = aser.id;

-- 8. Hapus kolom fisik/unik dari tabel parent (aset)
ALTER TABLE `aset`
